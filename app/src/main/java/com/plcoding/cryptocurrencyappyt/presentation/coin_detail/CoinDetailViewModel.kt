...
@HiltViewModel
class CoinDetailViewModel @Inject constructor(app: Application, private val getCoinUseCase: GetCoinDetailUserCase, saveStateHandle:SavedStateHandle) : AndroidViewModel(app) {
